            ...
            <div class="row products product-thumb-info-list" data-plugin-masonry data-plugin-options="{'layoutMode': 'fitRows'}">
                    ...
                    <span class="product-thumb-info border-0">
                        ...
                        <a href="shop-product-sidebar-left.html">
                            <span class="product-thumb-info-image">
                                <img alt="" class="img-fluid" src="/assets-front/img/products/product-grey-1.jpg">
                            </span>
                        </a>
                ...
                <div class="col-sm-6 col-lg-4 product">
                    <span class="product-thumb-info border-0">
                        ...
                        <a href="shop-product-sidebar-left.html">
                            <span class="product-thumb-info-image">
                                <img alt="" class="img-fluid" src="/assets-front/img/products/product-grey-2.jpg">
                            </span>
                        </a>
                        <span class="product-thumb-info-content product-thumb-info-content pl-0 bg-color-light">
                            <a href="shop-product-sidebar-left.html">
                ...
                <div class="col-sm-6 col-lg-4 product">
                    <span class="product-thumb-info border-0">
                        ...
                        <a href="shop-product-sidebar-left.html">
                            <span class="product-thumb-info-image">
                                <img alt="" class="img-fluid" src="/assets-front/img/products/product-grey-3.jpg">
                            </span>
                        </a>
                        <span class="product-thumb-info-content product-thumb-info-content pl-0 bg-color-light">
                            <a href="shop-product-sidebar-left.html">
                ...
                <div class="col-sm-6 col-lg-4 product">
                    <span class="product-thumb-info border-0">
                        ...
                        <a href="shop-product-sidebar-left.html">
                            <span class="product-thumb-info-image">
                                <img alt="" class="img-fluid" src="/assets-front/img/products/product-grey-4.jpg">
                            </span>
                        </a>
                        <span class="product-thumb-info-content product-thumb-info-content pl-0 bg-color-light">
                            <a href="shop-product-sidebar-left.html">
                ...
                <div class="col-sm-6 col-lg-4 product">
                    <span class="product-thumb-info border-0">
                        ...
                        <a href="shop-product-sidebar-left.html">
                            <span class="product-thumb-info-image">
                                <img alt="" class="img-fluid" src="/assets-front/img/products/product-grey-5.jpg">
                            </span>
                        </a>
                        <span class="product-thumb-info-content product-thumb-info-content pl-0 bg-color-light">
                            <a href="shop-product-sidebar-left.html">
                ...
                <div class="col-sm-6 col-lg-4 product">
                    ...
                    <span class="product-thumb-info border-0">
                        ...
                        <a href="shop-product-sidebar-left.html">
                            <span class="product-thumb-info-image">
                                <img alt="" class="img-fluid" src="/assets-front/img/products/product-grey-6.jpg">
                            </span>
                        </a>
                        <span class="product-thumb-info-content product-thumb-info-content pl-0 bg-color-light">
                            <a href="shop-product-sidebar-left.html">
                ...
                <div class="col-sm-6 col-lg-4 product">
                    <span class="product-thumb-info border-0">
                        ...
                        <a href="shop-product-sidebar-left.html">
                            <span class="product-thumb-info-image">
                                <img alt="" class="img-fluid" src="/assets-front/img/products/product-grey-7.jpg">
                            </span>
                        </a>
                        <span class="product-thumb-info-content product-thumb-info-content pl-0 bg-color-light">
                            <a href="shop-product-sidebar-left.html">
                ...
                <div class="col-sm-6 col-lg-4 product">
                    <span class="product-thumb-info border-0">
                        ...
                        <a href="shop-product-sidebar-left.html">
                            <span class="product-thumb-info-image">
                                <img alt="" class="img-fluid" src="/assets-front/img/products/product-grey-8.jpg">
                            </span>
                        </a>
                        <span class="product-thumb-info-content product-thumb-info-content pl-0 bg-color-light">
                            <a href="shop-product-sidebar-left.html">
                ...
                <div class="col-sm-6 col-lg-4 product">
                    ...
                    <span class="product-thumb-info border-0">
                        ...
                        <a href="shop-product-sidebar-left.html">
                            <span class="product-thumb-info-image">
                                <img alt="" class="img-fluid" src="/assets-front/img/products/product-grey-9.jpg">
                            </span>
                        </a>
                        <span class="product-thumb-info-content product-thumb-info-content pl-0 bg-color-light">
                            <a href="shop-product-sidebar-left.html">
