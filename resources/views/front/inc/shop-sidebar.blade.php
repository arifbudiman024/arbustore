            ...
            <ul class="simple-post-list">
                    ...
                    <div class="post-image">
                        <div class="d-block">
                            <a href="shop-product-sidebar-left.html">
                                <img alt="" width="60" height="60" class="img-fluid" src="/assets-front/img/products/product-grey-1.jpg">
                            </a>
                        </div>
                    </div>
                    <div class="post-info">
                ...
                <li>
                    <div class="post-image">
                        <div class="d-block">
                            <a href="shop-product-sidebar-left.html">
                                <img alt="" width="60" height="60" class="img-fluid" src="/assets-front/img/products/product-grey-4.jpg">
                            </a>
                        </div>
                    </div>
                    <div class="post-info">
                ...
                <li>
                    <div class="post-image">
                        <div class="d-block">
                            <a href="shop-product-sidebar-left.html">
                                <img alt="" width="60" height="60" class="img-fluid" src="/assets-front/img/products/product-grey-8.jpg">
                            </a>
                        </div>
                    </div>
                    <div class="post-info">
